...
def main():
    ...
    parser.add_argument('--file_map', type=str, default='sulibao:slb', help='Comma-separated key-value pairs for file mapping (e.g., source_db1:target_db1,source_db2:target_db2).')
